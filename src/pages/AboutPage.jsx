  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about Braided Beauty's story, our expert team, and our commitment to providing exceptional hair braiding and styling services."
        />
      </Helmet>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg text-gray-600">
                  ...
                  personality, and our mission is to help every client discover
                  their most confident self through expert styling and
                  personalized care.
                </p>
              </motion.div>
              ...
              {[
                {
                  ...
                  title: "Excellence",
                  description:
                    "We strive for perfection in every braid, every style, and every client interaction.",
                },
                {
                  icon: Heart,
                  title: "Care",
                  description:
                    "Your hair health and satisfaction are our top priorities in everything we do.",
                },
                {
                  icon: Users,
                  title: "Community",
                  description:
                    "We celebrate diversity and create a welcoming space for all hair types and textures.",
                },
                {
                  icon: Clock,
                  title: "Reliability",
                  description:
                    "Consistent quality service and respect for your time, every appointment.",
                },
              ].map((value, index) => (
                <motion.div
                  key={index}
